...
//Metodo GET de AJAX para recopilar la información dependiendo de la Actividad y Reino
    $(document).ready(function () {
        ...
        var contadorplusa2 = 0;
        var contadornega2 = 0;
        
        var contadorplusa3 = 0;
        var contadornega3 = 0; 
        
        var contadorplusa4 = 0;
        var contadornega4 = 0;
        ...
        $.ajax({  
            ...
            success: function (data) {                 
                $.each(data, function (i, item) {
                    var rows = item.fet_be;
                    var actividad = item.nom;
                    if (actividad == "Activitat1RN") {
                        if (rows == true) {
                            contadorplusa1++;
                        }  else {
                            contadornega1++;
                        }                    
                        $('.textoresba1').text(contadorplusa1); 
                        $('.textoresma1').text(contadornega1);
                        var calculo1 = contadorplusa1*100/(contadorplusa1+contadornega1)
                        $(".BarraFinal").css("width",calculo1+"%");
                    } else if (actividad == "Activitat2RN") {
                        if (rows == true) {
                            contadorplusa2++;
                        }  else {
                            contadornega2++;
                        }                    
                        $('.textoresba2').text(contadorplusa2); 
                        $('.textoresma2').text(contadornega2);
                        var calculo2 = contadorplusa2*100/(contadorplusa2+contadornega2)
                        $(".BarraFinal2").css("width",calculo2+"%"); 
                    } else if (actividad == "Activitat3RN") {
                        if (rows == true) {
                            contadorplusa3++;
                        }  else {
                            contadornega3++;
                        }                    
                        $('.textoresba3').text(contadorplusa3); 
                        $('.textoresma3').text(contadornega3);
                        var calculo3 = contadorplusa3*100/(contadorplusa3+contadornega3)
                        $(".BarraFinal3").css("width",calculo3+"%"); 
                    } else if (actividad == "Activitat1RC") {
                        if (rows == true) {
                            contadorplusa4++;
                        }  else {
                            contadornega4++;
                        }                    
                        $('.textoresba4').text(contadorplusa4); 
                        $('.textoresma4').text(contadornega4);
                        var calculo4 = contadorplusa4*100/(contadorplusa4+contadornega4)
                        $(".BarraFinal4").css("width",calculo4+"%"); 
                    }
